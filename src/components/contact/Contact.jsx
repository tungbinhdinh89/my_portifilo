          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">
                tungbinhdinh89@gmail.com
              </span>
              <a
                href="mailto:tungbinhdinh89@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">0942-211-112</span>
              <a
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">tungbinhdinh89</span>
